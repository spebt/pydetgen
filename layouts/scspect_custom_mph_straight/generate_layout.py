...
from helper import (
    ...
    generate_straight_pinhole_collimators,
...
if __name__ == "__main__":
    ...
    cfg = {
        ...
        # Straight Pinhole Collimator specs
        "pinhole_diameter_mm": 0.4,
        "n_pinholes": 72,
        # Centered at 65mm radius, with a 10mm thickness, it spans 60mm to 70mm 
    ...
    print("Generating straight pinhole collimators...")
    # This now returns a single tensor since we don't need inner/outer bi-conical separation
    plate_segments = generate_straight_pinhole_collimators(
    ...
    output_data = {
        "scanner MD5": f"sc_spect_hybrid_mph_straight_{cfg['n_pinholes']}_{cfg['collimator_thickness_mm']}_{cfg['pinhole_diameter_mm']}",
        "motion_parameters": {
    ...
    out_file_name = os.path.join(output_dir, f"hybrid_sc_spect_mph_straight_base_{cfg['n_pinholes']}_{cfg['collimator_thickness_mm']}_{cfg['pinhole_diameter_mm']}.tensor")
    ...
    plot_polygons_from_vertices_2d_mpl(
        base_layout["plate segments"], ax, facecolor='gray', edgecolor='black', label="Straight Pinhole Collimator"
    )
    ...
    plot_filename = f"hybrid_sc_spect_mph_straight_base_layout_{cfg['n_pinholes']}_{cfg['collimator_thickness_mm']}_{cfg['pinhole_diameter_mm']}.png"
